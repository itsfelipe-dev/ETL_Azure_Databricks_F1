...
results_df = spark.read.parquet(f"{processed_folder_path}/results").withColumnRenamed(
    "time", "race_time"
)
...
display(final_df.filter("race_name == 'Abu Dhabi Grand Prix' and race_year == 2020 ").orderBy(final_df.points.desc()))
